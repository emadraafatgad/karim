        ...
        for rec in self:
            ...
            for line in orders:
                ...
                if line.apply_discount:
                    ...
                    total_discount = total_discount + line.sale_discount
                else:
                    if line.discount_type == 'amount':
                        total_amount = total_amount + line.amount_untaxed + line.discount_rate
                        total_discount = total_discount + line.discount_rate
                    elif line.discount_type == 'percent':
                        amount = line.amount_untaxed/(1-line.discount_rate/100)
                        total_amount = total_amount + amount
                        total_discount = total_discount + amount - line.amount_untaxed
