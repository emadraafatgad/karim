...

{
    ...
    'version': '12.0.0.1',
    'category': 'Warehouse',
    'summary': 'This module help to print Inventory Age Report and Inventory Breakdown Report filter by warehouse and filter location according to a given period.',
    'description': """
    ...
    'live_test_url':'https://www.youtube.com/watch?v=SBu1c6yp2jw&feature=youtu.be',
    'price': 69,
    'currency': "EUR",
    'demo': [],
    'test': [],
