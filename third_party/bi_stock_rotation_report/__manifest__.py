# -*- coding: utf-8 -*-
{
    ...
    'version' : "12.0.0.0",
    'summary': 'This apps helps to generate included transfer stock report with opening stock and closing stock.',
    'description': """
    ...
    "auto_install": False,
    "installable": True,
    'live_test_url':'https://www.youtube.com/watch?v=VhE6Yg2Qq9o&feature=youtu.be',
